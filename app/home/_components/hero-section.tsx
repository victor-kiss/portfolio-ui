  ...
  return (
    <>
      <div className="relative w-full h-screen overflow-hidden">
        ...
        <div className="absolute inset-0 w-full h-full flex items-center justify-center flex-col select-none pointer-events-none blur-sm overflow-hidden">
        ...
        >
          <span className="bg-black/70 text-white px-4 py-2.5 text-xs sm:text-sm shadow-md backdrop-blur-sm tracking-widest pointer-events-auto">
            {/* Mostra uma mensagem se for touch ou desktop */}
            <span className="block sm:hidden">
              ⇄ Use dois dedos para girar o modelo 3D.
            </span>
            <span className="hidden sm:block">
              ↺ Clique e arraste para girar o modelo 3D.
            </span>
          </span>
        </motion.div>
      </div>
