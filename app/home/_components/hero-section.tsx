  ...
  return (
    <>
      <div className="relative w-full h-screen overflow-hidden">
        ...
        <div className="absolute bottom-0 w-full h-20 bg-linear-to-t from-white via-white/10 to-transparent z-50 backdrop-blur-md [mask-image:linear-gradient(to_top,black_20%,transparent_100%)] pointer-events-none"></div>
        ...
        <div className="w-full h-screen p-14 xl:p-0 bg-linear-to-r from-slate-200 via-slate-300 to-slate-200 ">
           <HeroScene />
        </div>  
